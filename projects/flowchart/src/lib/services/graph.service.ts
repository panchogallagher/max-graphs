...
export class GraphService {
  ...
  @Output() onApplyRelationSetting: EventEmitter<Relationship> = new EventEmitter();
  ...
  applyRelationSetting(relationship: Relationship) {
    this.onApplyRelationSetting.emit(relationship);
  }
